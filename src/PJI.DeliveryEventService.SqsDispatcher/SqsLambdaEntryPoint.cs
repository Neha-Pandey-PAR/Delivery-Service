...
using PJI.DeliveryEventService.SqsDispatcher.SecretsManager;
...
///   <c>PJI.DeliveryEventService.SqsDispatcher::PJI.DeliveryEventService.SqsDispatcher.SqsLambdaEntryPoint::FunctionHandlerAsync</c>
/// 
...
public class SqsLambdaEntryPoint
{
    ...
    public async Task<SQSBatchResponse> FunctionHandlerAsync(SQSEvent sqsEvent, ILambdaContext context)
    {
        ...
        foreach (var record in sqsEvent.Records)
        {
            ...
            if (result == Dispatcher.ProcessResult.Retriable)
            {
